...
def draw_fade_stripe(draw, start_x, width, height, stripe_opacity):
    ...
    for i in range(width // 2, width - width // 2):
        draw.line([(start_x + i, 0), (start_x + i, height)],
                  fill=(stripe_color[0], stripe_color[1], stripe_color[2], stripe_opacity))
