...
def check_anchor_order(m):
    ...
    """
        m.anchors: anchor [3, 3, 2] 3层、3锚框、wh
    """
...
def check_anchors(dataset, model, thr=4.0, imgsz=640):
    ...
    def metric(k):  # compute metric
        ...
        """                  w           h
            k:  tensor([[ 34.57000, 431.79001],     # (9, 2)
                        [ 35.74400, 486.17999],
                        [ 43.54800, 420.16000],
                        [ 30.23800, 647.65997],
                        [ 42.97900, 484.62000],
            ...
            wh 是一个包含数据集中所有目标框宽和高的张量 # (26268, 2)
        """
          # (26268, 1, 2)  (1, 9, 2)
        r = wh[:, None] / k[None] # 每个目标框的wh / 每个锚点的wh # (26268, 9, 2) 最后一维是宽度比例和高度比例
        x = torch.min(r, 1 / r).min(2)[0]  # ratio metric # (26268, 9)
        best = x.max(1)[0]  # best_x # 9个锚框中最大的比例
