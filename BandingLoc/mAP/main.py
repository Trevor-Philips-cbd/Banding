...
parser.add_argument('--dr-path', type=str, required=True)
...
GT_PATH = "../datasets/stripe_dataset/evals/3/gt"
# DR_PATH = os.path.join(os.getcwd(), 'input', 'detection-results')
# DR_PATH = "../datasets/stripe_dataset/evals/3/dr"
...
pattern = r'(exp\d+)'
# 提取包含 exp 和数字的字符串
matches = re.findall(pattern, DR_PATH)
output_files_path = "output" + "_" + matches[0]
