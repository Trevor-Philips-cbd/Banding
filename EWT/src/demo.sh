...
python main.py --model EWT --scale 1 --patch_size 256 --save strip --reset
...
python main.py --data_test DIV2K --data_range 1-4 --scale 1 --pre_train /mnt/sdc/org/home/bdc/EWT/experiment/gray-1/model/model_best.pt --test_only --save_results --reset
